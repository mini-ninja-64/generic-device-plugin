	...
	for _, tc := range []struct {
		...
		},
		{
			...
			fs: fstest.MapFS{
				...
				"sys/bus/usb/devices/1-4/product":   {Data: []byte("Example Product\n")},
			},
			out: []device{
				{
					deviceSpecs: []*v1beta1.DeviceSpec{
		...
		},
		{
			...
			fs: fstest.MapFS{
				...
				"sys/bus/usb/devices/1-4/busnum":                                        {Data: []byte("1\n")},
				"sys/bus/usb/devices/1-4/devnum":                                        {Data: []byte("4\n")},
				"sys/bus/usb/devices/1-4/1-4.1/1-4.1:1.0/ttyUSB0/tty/ttyUSB0/subsystem": {Data: []byte("../../../../../../../../../../class/tty"), Mode: fs.ModeSymlink},
				"sys/class/tty": {Data: []byte("test\n"), Mode: fs.ModeDir},
			},
			out: []device{
				{
